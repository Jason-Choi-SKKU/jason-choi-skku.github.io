...
- Investigate the feasibility of using FastText for Korean context inference quizzes
- Design MSA services considering computing resources of servers
- API design using Flask and FastAPI
- Develop a web application using React
